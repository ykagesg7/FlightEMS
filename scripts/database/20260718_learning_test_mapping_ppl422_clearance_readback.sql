-- PPL Subject 4 Phase 1 第4本 mapping — 管制許可等4 + 通則5 = 9問
-- Clusters: 飛行場管制/管制許可等, 管制業務一般/管制業務の通則
...
SELECT
  ...
  v.topic_category,
  '航空通信',
  'ppl422_20260718_clearance_readback',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-4-2-2_ClearanceReadbackBasics', '飛行場管制/管制許可等', '航空通信/管制許可等'),
  ('PPL-4-2-2_ClearanceReadbackBasics', '管制業務一般/管制業務の通則', '航空通信/管制業務の通則')
