-- PPL Subject 4 Phase 1 第5本 mapping — 地上滑走及び出発5 + 到着機2 = 7問
-- 可視信号(15) は 4-3-1 側に残す
...
SELECT
  ...
  v.topic_category,
  '航空通信',
  'ppl423_20260718_aerodrome_control',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-4-2-3_AerodromeControlBasics', '飛行場管制/地上滑走及び出発', '航空通信/地上滑走及び出発'),
  ('PPL-4-2-3_AerodromeControlBasics', '飛行場管制/到着機', '航空通信/到着機')
