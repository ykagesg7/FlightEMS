-- PPL Subject 4 Phase 1 第1本 mapping — 航空交通業務 75問（52+23）
-- Clusters: 航空交通業務, 航空交通業務概論/航空交通業務
...
SELECT
  ...
  v.topic_category,
  '航空通信',
  'ppl411_20260714_air_traffic_services',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-4-1-1_AirTrafficServicesOverview', '航空交通業務', '航空通信/航空交通業務'),
  ('PPL-4-1-1_AirTrafficServicesOverview', '航空交通業務概論/航空交通業務', '航空通信/航空交通業務概論')
