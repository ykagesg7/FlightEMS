-- PPL Subject 3 Phase 2 第2本: learning_test_mapping（航法計器1問）
-- Cluster: 航法に関する一般知識/航法計器
...
SELECT
  ...
  v.topic_category,
  '空中航法',
  'ppl322_20260708_radio_navigation',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-3-2-2_RadioNavigationOverview', '航法に関する一般知識/航法計器', '空中航法/航法計器')
