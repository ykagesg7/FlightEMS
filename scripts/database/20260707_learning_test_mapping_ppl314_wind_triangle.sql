-- PPL Subject 3 Phase 1 第4本: learning_test_mapping（風力三角形15 + 航法計算7 = 22問）
-- Clusters: 航法に関する一般知識/風力三角形に関する知識, 航法に関する一般知識/航法計算
...
SELECT
  ...
  v.topic_category,
  '空中航法',
  'ppl314_20260707_wind_triangle',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-3-1-4_WindTriangleAndFlightComputer', '航法に関する一般知識/風力三角形に関する知識', '空中航法/風力三角形'),
  ('PPL-3-1-4_WindTriangleAndFlightComputer', '航法に関する一般知識/航法計算', '空中航法/航法計算')
