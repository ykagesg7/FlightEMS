...
| **USAF Contact（操縦）** ep.1 ストック | [`20260816_learning_contents_ctx_area_and_purpose.sql`](20260816_learning_contents_ctx_area_and_purpose.sql)（`CTX-1-1_AreaAndPurpose`、`order_index` **611**、`is_published: false`） |
| **USAF Contact（操縦）** ep.2 W34 | [`20260816_learning_contents_ctx_energy.sql`](20260816_learning_contents_ctx_energy.sql)（`CTX-1-2_Energy`、`order_index` **612**、`is_published: false`、公開 8/19） |
| **USAF Contact（操縦）** ep.3 W34 | [`20260816_learning_contents_ctx_controls_g_pio.sql`](20260816_learning_contents_ctx_controls_g_pio.sql)（`CTX-1-3_ControlsGPio`、`order_index` **613**、`is_published: false`、公開 8/21） |
