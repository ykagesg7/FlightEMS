...
| **PPL Subject 1 工学 `learning_test_mapping` バックフィル** | [`20260627_backfill_ppl_engineering_test_mapping.sql`](20260627_backfill_ppl_engineering_test_mapping.sql)（[`20260329`](20260329_learning_test_mapping_incremental_ppl_clusters.sql) の再適用用。**2026-06-27 本番適用済**: `PPL-1-1-2`〜`1-1-10`。`PPL-1-2-1`〜`7` は `learning_contents` 未登録で保留） |
