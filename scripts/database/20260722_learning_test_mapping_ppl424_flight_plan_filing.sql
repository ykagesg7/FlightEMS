-- PPL Subject 4 Phase 1 第6本 mapping — 記入要領18 + 通報4 = 22問
...
SELECT
  ...
  v.topic_category,
  '航空通信',
  'ppl424_20260722_flight_plan_filing',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-4-2-4_FlightPlanFilingBasics', '飛行計画/飛行計画記入要領', '航空通信/飛行計画記入要領'),
  ('PPL-4-2-4_FlightPlanFilingBasics', '飛行計画/飛行計画の通報', '航空通信/飛行計画の通報')
