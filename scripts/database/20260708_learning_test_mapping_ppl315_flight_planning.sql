-- PPL Subject 3 Phase 1 第5本: learning_test_mapping（航法計算7問）
-- Cluster: 航法に関する一般知識/航法計算
-- Note: 3-1-4 also maps 航法計算; both articles link to the same verified cluster.
...
SELECT
  ...
  v.topic_category,
  '空中航法',
  'ppl315_20260708_flight_planning',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-3-1-5_FlightPlanningBasics', '航法に関する一般知識/航法計算', '空中航法/航法計算')
