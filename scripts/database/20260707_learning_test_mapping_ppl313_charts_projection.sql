-- PPL Subject 3 Phase 1 第3本: learning_test_mapping（航空図13 + 投影法17 = 30問）
-- Clusters: 航法に関する一般知識/航空図, 航法に関する一般知識/航空図の投影法
...
SELECT
  ...
  v.topic_category,
  '空中航法',
  'ppl313_20260707_charts_projection',
  'verified'
FROM learning_contents lc
JOIN (VALUES
  ('PPL-3-1-3_AeronauticalChartsBasics', '航法に関する一般知識/航空図', '空中航法/航空図'),
  ('PPL-3-1-3_AeronauticalChartsBasics', '航法に関する一般知識/航空図の投影法', '空中航法/航空図の投影法')
