...
#### **ランクシステム（10段階）**
ユーザーは経験値（XP）に基づいて10段階のランクに分類されます：

1. **Fan** (0 XP) - ファン
2. **Spectator** (100 XP) - 観客
3. **Trainee** (200 XP) - 訓練生
4. **Student** (300 XP) - 学生
5. **Apprentice** (400 XP) - 見習い
6. **Pilot** (500 XP) - パイロット
7. **Wingman** (600 XP) - 僚機（体験搭乗予約権）
8. **Ace** (700 XP) - エース
9. **Master** (800 XP) - マスター
10. **Legend** (900 XP) - レジェンド
...
- **`check_rank_up`**: XPに基づくランクアップ判定（トリガー関数）
