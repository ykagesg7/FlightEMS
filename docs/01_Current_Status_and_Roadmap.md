...
**最終更新**: 2026年6月29日  
**バージョン**: Roadmap v4.0.32（PPL 進捗 40/150・Subject 2 Phase 1 6/12）
...
**PPL KPI**: Phase C 合算 **25/150** — **達成済**。Subject 2 Phase 1 **6/12 本**（累計 MDX **40/150**）。7月目安 **+4〜6 本**（累計 **38〜40/150** は既に到達）を [05](05_Content_Pipeline.md) 週次表に記録する。
...
| **PPL 記事**                        | **40/150（26.7%）** — MDX 実数（工学 20 + 法規 14 + 気象 **6**）。Subject 2 Phase 1 **6/12**（[`PPL-2-1-1`](../src/content/lessons/PPL-2-1-1_AtmosphereAndIsaBasics.mdx)〜`PPL-2-1-6`、`learning_contents` **201〜206**） | **継続（C-7）** — Phase C KPI **25/150 達成済**。2026年末 50% は**二次 KPI** |
