...
**バージョン**: Documentation Index v3.0
...
### 主要機能
1. **学習コンテンツ管理**: MDXベースの記事システム、進捗管理、シリーズ順次アンロック
2. **テスト・クイズシステム**: CPL試験問題、SRS（間隔反復学習）、進捗追跡
3. **フライトプランニング**: インタラクティブ地図、気象データ（METAR/TAF）、経路計画
4. **ゲーミフィケーション**: ランクシステム（Spectator/Trainee/Wingman）、XP、ミッション
...
**最終更新**: 2025年1月（CI/CD統合・テスト設定追加・フォルダ構造整理・コンポーネント整理）
