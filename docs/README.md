...
- **2026-08-17（週次テレメトリ ISO 火曜）**: レビューを **火曜 09:00 JST**（月〜日）へ切替。Slack `#fa-telemetry`。初回新窓 W34 は 8/25。フェーズ1 は GitHub Actions `weekly-telemetry-ga4` が ISO 週 JSON を artifact に置く。正本 [ops/Weekly_Telemetry_Review.md](ops/Weekly_Telemetry_Review.md)。
