...
| 2026-07-22 | W30 — **`PPL-4-3-2` 公開登録**（MAYDAY / PAN PAN + mapping 34 問）。Subject 4 Phase 1 **8/8 完走**。 |
| 2026-07-22 | W30 — **`PPL-4-3-1` 公開登録**（無線故障・ライトガン・三角形 + mapping 15 問）。Subject 4 Phase 1 **7/8**。 |
| 2026-07-22 | W30 — **`PPL-4-2-4` 公開登録**（FPL 提出・変更・クローズ + mapping 22 問）。Subject 4 Phase 1 **6/8**。 |
| 2026-07-18 | W30 — **`PPL-4-2-3` 公開登録**（飛行場管制 + mapping 7 問）。Subject 4 Phase 1 **5/8**。 |
| 2026-07-18 | W30 — **`PPL-4-2-2` 公開登録**（クリアランス・復唱 + mapping 9 問）。Subject 4 Phase 1 **4/8**。 |
| 2026-07-18 | W30 — **`PPL-4-2-1` 公開登録**（フレーズロジー + mapping 41 問）。Subject 4 Phase 1 **3/8**。 |
