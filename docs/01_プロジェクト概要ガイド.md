...
#### **サポートされるコンポーネント**
1. **CalloutBox** - 情報ボックス（info, warning, success, error）
2. **ImageWithComment** - 画像とコメント表示
3. **Mermaid図表** - フローチャート、シーケンス図
...
### **品質管理**
- **型安全性**: any型ほぼ排除（147箇所から段階的削減中）
- **ESLint/Prettier**: 静的解析による品質確保
- **Vitest+React Testing Library**: 包括的テスト環境
- **CI/CD**: Vercel/Supabase/GitHub Actionsによる自動化
