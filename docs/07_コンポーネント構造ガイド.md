...
- **レッスン MDX のアフィリエイト用 raw `div`**: ルートに **`not-prose`**、レイアウトは **CSS Grid**（`src/content/lessons/*.mdx` の Monetization Spot）。新規追加時は [05_設計仕様書.md](05_設計仕様書.md)「MDX 表示・学習者向け文言」を参照。
