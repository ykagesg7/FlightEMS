...
| **2026-W33**（〜2026-08-19） | **4**（途中 2026-08-12） | ① **Articles** `4.2.1`〜`4.2.3` 公開済・`4.2.4`/`4.2.5` 予定（[`20260808_learning_contents_w33_training_basics.sql`](../scripts/database/20260808_learning_contents_w33_training_basics.sql)）。② **CBT 方針メモ** [CBT_Example_Reclassification_Memo](CBT_Example_Reclassification_Memo.md) + 第1バッチ 通信 **11**→`CPL-Hub-Communication`（[`20260812_learning_test_mapping_cbt_comm_hub.sql`](../scripts/database/20260812_learning_test_mapping_cbt_comm_hub.sql)）。③ MCP: 未マッピング総 **103**（CBT 残 **93** + レガシー **10**）、mapping **141 行**。④ PPL `2-3-3` は W34〜 へ延期。 |
| **2026-W34**（〜2026-08-26） | **5** | ① **CBT 第2バッチ**: 気象 **18** + 航法 **18** → 各ハブ（[`20260812_learning_test_mapping_cbt_meteo_nav_hub.sql`](../scripts/database/20260812_learning_test_mapping_cbt_meteo_nav_hub.sql)）。② **Action2/3 方針** [Post_Exam_Action2_Action3_Policy_Memo](Post_Exam_Action2_Action3_Policy_Memo.md)。③ **PPL-2-3-3** 深文化 + mapping（[`20260812_*ppl233*`](../scripts/database/20260812_learning_contents_ppl233_wind_shear_volcanic_ash.sql)）。④ MCP: 未マッピング総 **67**（CBT **57** + レガシー **10**）、mapping **145 行**、PPL **64/150**。 |
...
| **2026-W39**（〜2026-09-28） | **3**（予定） | ① **A2-a 判定** + A2-b Go/No-Go。② Articles **CP 5-3 / 5-4 / 5-5**（9/20・23・25）。③ CBT Phase B 第2バッチ（余力）。 |
