...
| **ドリップは CP が先** | W34 は CP 1-1〜1-3。W35 は CP 2-1〜2-3。W36 は CP 2-4〜2-6。W37 は CP 3-1・3-2・4-1。FMT 1-1〜1-3 は倉庫 |
...
**W36（2026-08-30 / 9/2 / 9/4）**: CP 2-4 → 2-5 → 2-6（Season 2 完結）。1 話目は日曜案内と同時。FMT はこの週も出さない。

**W37（2026-09-06 / 9/9 / 9/11）**: CP 3-1 → 3-2 → 4-1（Season 3 完結＋Nose-high 前倒し）。FMT はこの週も出さない。日曜（9/6）17:00 案内の対象。
...
Season 1 全 **10 話**＝週3本なら約 **3.5 週**。W34 は CP。FMT のドリップ開始週は未定。
...
**Season 1 は 1-10 までストック済。** 読む順は **CP → FMT**。W34 ドリップは CP 1-1〜1-3。[Contact_Transition_2026](../Contact_Transition_2026/README.md)。Season 2 のブリーフは求められたときだけ。全 18 本を一括起票しない。
