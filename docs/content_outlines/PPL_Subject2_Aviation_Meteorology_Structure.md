...
| CPL 記事 | 現状の PPL Callout | Phase 1 後の追加・差し替え先 |
|----------|-------------------|------------------------------|
| 3.3.1 | ~~PPL-1-1-1~~ → **`PPL-2-1-1` 追加済**（2026-06-24） | **`PPL-2-1-2`・`PPL-2-1-3` 追加済**（2026-06-24〜25） |
| 3.3.5 | （要確認） | `PPL-2-1-5` |
| 3.3.10 / 3.3.11 | （要確認） | `PPL-2-1-6`, `PPL-2-1-7` |
| 3.3.3 / 3.3.4 | （要確認） | `PPL-2-2-2`, `PPL-2-2-3` |
| 3.3.12 | （要確認） | `PPL-2-3-1` |
