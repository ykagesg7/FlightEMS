...
**作成日**: 2026-04-10  
**スナップショット更新**: 2026-06-27（リポジトリ MDX **88**・**PPL 38**。DB マッピング指標は **2026-06-06** MCP のまま）  
