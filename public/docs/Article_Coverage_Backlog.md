...
**作成日**: 2026-04-10  
**スナップショット更新**: 2026-06-28（リポジトリ MDX **89**・**PPL 39**。DB マッピング **2026-06-28 MCP** 更新）  
...
| **`learning_contents` 総行数** | **109**（見込み） | 2026-04-13 MCP スナップショット **90**。**2026-06-28** Subject 2 **+1**（205）。**2026-06-27** **+1**（204）。**2026-06-24〜25** **+3**（201〜203）。**2026-05-12** は **+4** + **+3** + **+7**（法規）。**再取得未取得の場合は 90 と併記**。 |
| **`learning_contents`・category 内訳** | CPL学科 **49** / PPL **39**（見込み：工学 **20** + 法規 **14** + 気象 **5**） / メンタリティー **15** / 思考法 **13** | PPL 法規 **`order_index` 501〜514**（2026-05-12）。Subject 2 気象 **`order_index` 201〜205**（2026-06-24〜28）— [PPL_Subject2 構造案](content_outlines/PPL_Subject2_Aviation_Meteorology_Structure.md) |
| **PPL 記事のマッピング** | **39 / 39 MDX** | 法規 **14**・気象 **5**・工学 **20**（`PPL-1-*` 全本） |
| **`learning_test_mapping` がある記事** | **88** | `COUNT(DISTINCT learning_content_id)`・2026-06-28 MCP |
| **`learning_test_mapping` 行数** | **98** | 2026-06-28 MCP（`PPL-2-1-5` **+1**） |
| **verified 未マッピング設問** | **36**（暫定） | 2026-06-06 §5.2 クエリ — **再集計未実施** |
| **リポジトリ `src/content/lessons/*.mdx`** | **89** | 2026-06-28（PPL **39** / CPL 3.x **44** / その他 **6**） |
...
|------|----------|------------------------------|-------------------------|------|
| **PPL-2-1（気象 Phase 1）** | 5 本 | **7 CPL 本**更新済（`3.3.1/2/5/6/8/10/11`） | **5/5** 済 | [構造案 §8](content_outlines/PPL_Subject2_Aviation_Meteorology_Structure.md) |
