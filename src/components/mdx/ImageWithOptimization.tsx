      ...
      <figure className={`my-6 ${className}`}>
        <div className="relative">
          ...
          {isLoading && (
            ...
            `}>
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[color:var(--hud-primary)]"></div>
            </div>
          )}
        ...
        {caption && (
          <figcaption className={`
            mt-2 text-sm text-center italic text-[color:var(--text-primary)] opacity-70
          `}>
            {caption}
          </figcaption>
        )}
