      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-2xl rounded-xl shadow-2xl bg-white">
          ...
          {user ? (
            <div className="p-6 border-t border-gray-200">
              <form onSubmit={handleSubmit} className="space-y-4">
                <textarea
                  ...
                  rows={3}
                  className="w-full p-3 rounded-lg border resize-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-white border-gray-300 text-gray-900 placeholder-gray-500"
            ...
            <div className="p-6 border-t text-center border-gray-200 text-gray-500">
