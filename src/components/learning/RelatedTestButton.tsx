...
const RelatedTestButton: React.FC<RelatedTestButtonProps> = ({
  ...
  return (
    <div className="mt-8 p-6 rounded-lg border-l-4 bg-gradient-to-r from-blue-900/20 to-indigo-900/20 border-blue-400 text-white">
      ...
      <Link
        ...
        className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white transition-all duration-200 transform hover:scale-105 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
      >
