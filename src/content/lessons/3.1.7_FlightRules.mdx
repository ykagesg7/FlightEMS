...
<Image
  src="https://placehold.co/1200x630/1a1a1a/FFF?text=Flight%2BRules"
  alt="【航空法規】運航規則の詳細（CPL学科・スタブ）"
  width={1200}
  height={630}
/>
...
**main_subject**: `航空法規` / **sub_subject**: `運航` を含むクラスタを主対象とする。

- Visual / Instrument の枠組みと例外の探し方
- 実務と条文の橋渡し（スタブ段階は見出しのみ）
